      ...
      (compilation, callback) => {
        ...
        try {
          ...
          const writeFile = (relativeFilePath, buffer) => {
            ...
            console.dir("Writing file " + relativeFilePath + " to: " + variable);
            var size = 0;
          ...
          const writeFiles = () => {
            ...
            debugger
            console.dir("Process assets");
            Object.keys(assets).forEach((relativeFilePath) => {
              const filePath = buildPath + "/" + relativeFilePath;
              debugger
              console.dir(filePath);

              const readStream = readFileSync(filePath);
              writeFile(relativeFilePath, coherseToBuffer(readStream));
